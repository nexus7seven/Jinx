...
<style>
.wip-assistant{height:100%;box-sizing:border-box;background:linear-gradient(180deg,#111b31 0%,#0f172a 100%);border:1px solid #334155;border-radius:12px;overflow:hidden;display:flex;flex-direction:column;box-shadow:0 16px 40px rgba(0,0,0,.18)}
