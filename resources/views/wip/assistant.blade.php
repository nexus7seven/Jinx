...
<style>
.wip-assistant{position:sticky;top:18px;background:#0f172a;border:1px solid #334155;border-radius:14px;overflow:hidden;min-height:760px;display:flex;flex-direction:column;box-shadow:0 16px 40px rgba(0,0,0,.2)}
.wip-assistant__head{padding:14px 16px;border-bottom:1px solid #334155;display:flex;justify-content:space-between;gap:10px;align-items:center}.wip-assistant__head strong{font-size:19px}.wip-assistant__head div div{font-size:11px;color:#64748b;margin-top:3px}.wip-assistant__head button{background:#111827;color:#94a3b8;border:1px solid #334155;border-radius:7px;padding:6px 9px;cursor:pointer}
.wip-assistant__history{flex:1;min-height:560px;max-height:calc(100vh - 260px);overflow:auto;padding:12px}.wip-assistant__msg{padding:9px 10px;border-radius:10px;margin-bottom:9px;white-space:pre-wrap;font-size:13px;line-height:1.4}.wip-assistant__msg--user{margin-left:25px;background:#1d4ed8}.wip-assistant__msg--assistant{margin-right:15px;background:#111827;border:1px solid #334155}.wip-assistant__label{display:block;font-size:9px;font-weight:800;text-transform:uppercase;opacity:.6;margin-bottom:3px}
